      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          ...
          <p className="text-sm mb-4 text-gray-400">
            Unite a nuestro canal para recibir recursos gratuitos, tips de
            estudio y novedades.
          </p>
          <a
            ...
            className="inline-flex items-center gap-2 text-sm font-medium text-white bg-white/5 hover:bg-brand-primary/20 border border-gray-700 hover:border-brand-primary py-2 px-4 rounded-lg transition-all"
          >
            <svg
