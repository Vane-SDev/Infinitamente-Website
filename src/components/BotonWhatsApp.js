...
export default function BotonWhatsApp() {
  ...
  useEffect(() => {
    // Iniciamos mostrando la burbuja a los 2 segundos de entrar a la web
    const timeoutInicial = setTimeout(() => setMostrarBurbuja(true), 2000);

    // Configuramos el ciclo repetitivo: cada 15 segundos se ejecuta esto
    const intervalo = setInterval(() => {
      setMostrarBurbuja(true); 

      // La esconde después de 5 segundos
      setTimeout(() => {
